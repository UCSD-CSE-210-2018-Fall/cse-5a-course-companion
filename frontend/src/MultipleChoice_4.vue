...
<script>
const variable_Question_Header = ["Question 4", "Which of the following is an invalid way of initializng a variable?", ""];
const variable_Question_Choices = ["int i;","int i, j, k;","double k = 5;","int i, j, k = 5;"];
const variable_Responses = ["This is correct","This is correct","This is correct",null];
