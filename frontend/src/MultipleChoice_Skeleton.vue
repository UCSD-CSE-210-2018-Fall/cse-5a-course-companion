...
<script>
/* const variable_Question_Header = ["Question Number", "Question", "Question content"];
*  const variable_Question_Choices = ["Answer 1;","Answer 2","Answer 3","Answer 4"];
*  const variable_Responses = ["Response 1","Response 2","Response 3","Response 4"];
*  const correct_Answer = 0;
*/
const variable_Question_Header = [
    "Question Number", 
    "Question", 
    "Question content"
];
const variable_Question_Choices = [
    "Answer 1;",
    "Answer 2",
    "Answer 3",
    "Answer 4"
];
const variable_Responses = [
    "Response 1",
    "Response 2",
    "Response 3",
    "Response 4"
